...
const namespace = "outWarehouseSaleOrder";
...
class AddOrder extends Component {
    ...
    constructor(props) {
        ...
        this.postFinishOrderToServer = this.postFinishOrderToServer.bind(this)
    ...
    updateTableData() {
        ...
        this.state.selectedSaleOrder.map((order,index)=>{
            tableDataTemp.push({
                ...
                ...(order),
                thisTimeDeliveredSum: <Input onChange={(e) => {
    ...
    submit() {
        ...
        for (let field in all) {
            ...
            if(field==="selectedSaleOrder"){
                ...
                all[field].map((saleOrder,index)=>{
                    if(!saleOrder.thisTimeDeliveredSum){
                        flag = false;
                    }
                    ...
                    isNumber=regExp.test(saleOrder.thisTimeDeliveredSum);
                })
        ...
        if (flag) {
            if (!isNumber) {
                ...
                this.postFinishOrderToServer("/postFinishOrderList", "post",
                    all).then(
                        value => {
                            alert(value);
    ...
    postFinishOrderToServer(url, option, data) {
